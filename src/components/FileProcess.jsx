...
//   this identify length b/t coords
  ...
  return (
    <div>
      ...
      <button onClick={() => (console.log(summary),setShowSummary(true),setShowDetails(true))}>Summary</button>
      <button onClick={() => (console.log(details),setShowCoDetails(true))}>Detailed</button>
      {showSummary && (
        <table border="1">
          <thead>
            <tr>
      ...
      {showCoDetails && coordinates.length > 0 && (
        <div>
          <h3>Coordinates</h3>
          <ul>
